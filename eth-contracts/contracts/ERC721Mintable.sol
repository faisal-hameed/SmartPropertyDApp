...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "Only owner can operate");
        _;
    }
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Contract is open");
        _;
    }
    ...
    function setPausable(bool status) public onlyOwner {
        _paused = status;
    }
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(tokenOwner != to, "This address already owns this token");

        //TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(getOwner() == msg.sender || isApprovedForAll(msg.sender, to), "You are not authorized to approve this token." );
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Token can't be minted to invalid address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0), "Token can't be transfered to invalid address");
...
contract CustomERC721Token is ERC721Metadata ("Bahria Town Properties", "BTP", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
